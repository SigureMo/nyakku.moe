...
![DS01.jpg{copyright:BaiduImage}](../img/data-structures-and-algorithms/DS01.jpg)
...
![DS02.jpg{copyright:BaiduImage}](../img/data-structures-and-algorithms/DS02.jpg)
...
![DS03](../img/data-structures-and-algorithms/DS03.png)
...
-  建堆
   ...
   -  如果直接使用未排序的数组初始化数据域，再进行调整的话，时间复杂度可降到 $O(n)$
      ...
      ![DS04{copyright:Wangdao}](../img/data-structures-and-algorithms/DS04.png)
...
![DS05{copyright:BaiduImage}](../img/data-structures-and-algorithms/DS05.jpg)
...
![DS06{copyright:Wangdao}](../img/data-structures-and-algorithms/DS06.png)
...
![DS07{copyright:Wangdao}](../img/data-structures-and-algorithms/DS07.png)
...
![DS08{copyright:https://www.jianshu.com/p/03de0db4b857}](../img/data-structures-and-algorithms/DS08.png)
...
![DS09{copyright:https://www.jianshu.com/p/03de0db4b857}](../img/data-structures-and-algorithms/DS09.png)
...
-  **Prim 算法**
   ...
   ![DS10{copyright:Wangdao}](../img/data-structures-and-algorithms/DS10.png)
...
-  **Kruskal 算法**
   ...
   ![DS11{copyright:Wangdao}](../img/data-structures-and-algorithms/DS11.png)
...
-  有权图的单源最短路径
   ...
   ![DS12{copyright:Wangdao}](../img/data-structures-and-algorithms/DS12.png)
...
![DS13{copyright:Wangdao}](../img/data-structures-and-algorithms/DS13.png)

```cpp
void TopSort(){
    for (cnt = 0; cnt < |V|; cnt++){
        V = 未输出的入度为 0 的 Vertex;
        if (这样的 V 不存在) {
            Error("图中有回路");
            break;
        }
...
![DS14.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS14.png)
...
![DS15.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS15.png)
...
-  B 树的插入
   ...
   ![DS16.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS16.png)
...
-  B 树的删除
   ...
   -  若所删除的关键字不在终端结点
      ...
      -  如果都不满足，删掉该关键字，直接将两个子树合并
         ![DS17.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS17.png)

   -  若所删除的关键字在终端结点
      -  如果直接删去仍满足，则直接删除
      -  如果兄弟有富余，则将其“调整”过来即可
         ![DS18.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS18.png)
      -  如果兄弟没有富余，则需要删除之后将父结点中关键字放到兄弟那里
         ![DS19.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS19.png)

#### 8.3.2 B+ 树的基本概念

![DS20.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS20.png)
...
![DS21.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS21.png)
...
![DS22.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS22.png)
...
![DS23.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS23.png)

很容易想到哈夫曼树啦，将段长作为权值，则 WPL 最小的应该就是 I/O 次数最少的**最佳归并树**，当然，现在的哈夫曼树应当是 m 叉树了

![DS24.png{copyright:Wangdao}](../img/data-structures-and-algorithms/DS24.png)
