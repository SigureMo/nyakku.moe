...
class Julia(Language):
    ...
    def run(self):
        sh(["julia", self.file_path, *self.args])
...
class TypeScript(Language):
    ...
    def run(self):
        sh(["deno", "run", "--allow-all", self.file_path, *self.args])
...
class MATLAB(Language):
    ...
    def run(self):
        sh(["matlab", "-nosplash", "-nodesktop", "-r", self.file_name_no_ext, *self.args], cwd=self.dir_name)
